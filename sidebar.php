<?php if (!defined('__TYPECHO_ROOT_DIR__')) exit; ?>
	...
	for($i=1;$i<=$maxi;$i++){
		$icss=($i%2)+1;
		$tmp='<div class="widget widget_ui_textasb"><a class="style0'.$icss.'" href="'.$sad1[$i*3-3].'" target="_blank"><strong>吐血推荐</strong><h2>'.$sad1[$i*3-2].'</h2><p>'.$sad1[$i*3-1].'.</p></a></div>';
		echo $tmp;
	} ?>
	<?php endif; ?>
    ...
    <div class="widget widget_ui_tags">
      <h3>标签云</h3>
      <div class="items"><?php $this->widget('Widget_Metas_Tag_Cloud', 'ignoreZeroCount=1&limit=20')->to($tags); ?><?php while($tags->next()): ?>
